...
по принципу FIFO: первым пришел - первым вышел. Выполнение микрозадач, то есть их попадание в Call Stack, происходит 
только в том случае, если ничего больше не запущено в Call Stack'е. 
