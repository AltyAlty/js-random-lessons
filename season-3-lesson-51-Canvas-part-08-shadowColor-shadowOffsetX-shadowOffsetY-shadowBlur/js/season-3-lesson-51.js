...
/*Свойство "shadowColor" определяет цвет теней. На отображаемую непрозрачность тени будет влиять непрозрачность 
цвета в свойстве "fillStyle" при заливке и цвета в свойстве "strokeStyle" при обводке.
