/*Чтобы проанализоровать работу внутри функции в дебаггере, нужно ставить точку остановки внутри этой функции.*/

/*-------------------------------------------------------------------------------------------------------------------*/

/*Свойство "target" у объекта события указывает на элемент, в котором произошло событие, а свойство "currentTarget"
указывает на элемент, который подписан на это событие.*/
...
/*Функция-конструктор "Boolean" принимает значение и преобразовывает его в булево значение.*/
...
/*При сравнении строк идет посимвольное сравнение по ASCII значению до тех пор, пока не будет получено "true".*/
