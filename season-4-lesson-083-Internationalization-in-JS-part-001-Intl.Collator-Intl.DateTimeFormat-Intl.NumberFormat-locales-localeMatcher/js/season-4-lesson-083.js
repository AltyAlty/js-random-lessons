...
/*Рассмотрим конструктор "Intl.Collator". Первым параметром он принимает локаль, одна или массив в порядке 
...
/*Рассмотрим конструктор "Intl.DateTimeFormat". Первым параметром он принимает локаль, одна или массив в порядке 
...
/*Рассмотрим конструктор "Intl.NumberFormat". Первым параметром он принимает локаль, одна или массив в порядке 
предпочтения. Вторым необязательным параметром принимает объект с дополнительными настройками:
