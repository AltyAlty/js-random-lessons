...
Стиль прямоугольника определяется свойством "fillStyle".*/
...
добавленным к фигуре, градиент должен быть задан свойствами "fillStyle" или "strokeStyle". Метод 
...
градиент должен быть задан свойствами "fillStyle" или "strokeStyle". Метод "createRadialGradient()" принимает 
...
чтобы быть добавленным к фигуре, градиент должен быть задан свойствами "fillStyle" или "strokeStyle". Метод 
