...
/*
Транзакция - это совокупность операций. Если в процессе транзакции одна из операций прошла не усепшно, то все
операции в этой транзакции должны откатиться к исходному состояние. То есть прежде чем подтвердить транзакицию
