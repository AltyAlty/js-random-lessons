...
при помощи этого конструктора, скопируют в себя всю реализацию этого метода.
...
это свойство создается или изменияется, а в прототипе указать как метод, так и это 
...
/*Если в конструкторе не указать какое-то свойство и метод, в котором 
это свойство создается или изменяется в виде объекта, а в прототипе указать как метод, 
