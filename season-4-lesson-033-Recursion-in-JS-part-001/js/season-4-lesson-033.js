...
целях предотвращения бесконечного зацикливания. То есть при создании рекурсии всегда должен быть базовый случай рекурсии, 
...
но они еще не поддерживаются везде и работают только для простых случаев.*/
...
1) "value",
2) "next" – свойство, ссылающееся на следующий элемент связанного списка или null, если это последний элемент.*/
