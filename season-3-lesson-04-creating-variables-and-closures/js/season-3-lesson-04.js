...
/*Все "var" поднимаются на вверх программы, но без указания значений. Это называется "hoisting". Тоже самое происходит
...
/*Объявляем переменную "s" в глобальной области видимости и устанавливаем ее значение как объект.*/
var s = { a: 0 };
...
вверх, то есть в функцию, в которой она содержится, и так далее добираясь до глобальной области видимости.*/
function showX() {
    let x = 22;
