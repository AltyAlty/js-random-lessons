...
/*Массивы могут применятся как очередь. Можно удалять массивы как в конце, так и в начале массиве, то есть можем
...
console.log(array5.unshift(5, 6)); // 6
console.log(array5); // [5, 6, 4, 1, 2, 3]

console.log('--------------------------------------');

/*-------------------------------------------------------------------------------------------------------------------*/

/*Массив это подвид объектов, где в квадратных скобка вместо ключа используется индекс элемента. Движок JavaScript 
...
а не массивы, и поэтому могут быть в 10-100 раз медленнее.*/
