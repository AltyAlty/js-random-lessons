...
каждый элемент массива и вызывается с ним в качестве параметра указанную функцию. Указаннная функция может принимать
до трех параметров: элемент, индекс элемента и сам массив. Если указанная функция возвращает true, то поиск 
прекращается и возвращается найденный элемент, иначе возврашается undefined.*/
let array9 = [
    {a: 1},
    {a: 2},
    {a: 3},
...
let items1 = array10.filter(
    (item, index, array) => item.a === 3 && index && array
);
...
console.log(items2); // [ 0, 10, 30, 45, 100 ]
...
let result4 = array20.filter(obj1.canJoin, obj1);
