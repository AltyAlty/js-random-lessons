...
1) "%o" выводит объект JavaScript в стиле "оптимально полезного форматирования", например, элементы DOM могут отображаться
так же, как они будут выглядеть в инспекторе элементов.
