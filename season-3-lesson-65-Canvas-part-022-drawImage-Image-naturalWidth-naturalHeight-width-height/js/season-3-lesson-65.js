...
function drawImageActualSize() {    
    /*Используем изначальный размер нашего изображения для установки размеров холста при помощи свойств "naturalWidth" и
    "naturalHeight".*/
    ...
    /*Чтобы использовать заданный размер 120х90 в конструкторе "Image()", нам нужно указать параметры масштабирования,
    используя свойства "width" и "height", обозначающие ширину и высоту элемента.*/
