...
если его props не были изменены.*/

/*"Babel.JS" - это транспайлер, который преобразует ваш современный JavaScript для 
запуска в старых браузерах (новые стандарты в старый, JSX в JS и так далее).*/
...
/*Ключевое слово "super" создает "this" на расширяемом классе, то есть создаться
"this" родительского класса.*/
