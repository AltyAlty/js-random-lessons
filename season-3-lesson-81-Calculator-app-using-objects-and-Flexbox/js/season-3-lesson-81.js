...
const calculator = {
    ...
    calculateSomething: function (operation) {
        switch (operation) {
            ...
            case '=':
                /*Сначала провереям, что у нас есть текущее введенное первое число и поле для вывода не является пустым,
    ...
    findPlacesForRounding: function (numberOne, numberTwo, operation) {
        ...
        нас было сложение или вычичитание, то количество разрядов в дробной части будет равно "places".*/
