...
function GalleryBLL() {
    ...
    /*Метод, который позволяет установить массив URL изображений на уровне BLL,
    получив его с уровня UI, и отправить его на уровень DAL. В качестве 
    параметров принимает имя ключа, под которым нужно сохранить массив URL
    изображений в "local storage", и сам такой массив.*/
    ...
    параметра принимает имя ключа, под которым хранится массив URL изображений
    в "local storage".*/
