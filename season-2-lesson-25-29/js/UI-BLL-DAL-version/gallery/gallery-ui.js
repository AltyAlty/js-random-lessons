...
function GalleryUI() {
    ...
    /*Метод, который отрисовывает галлерею на странице. В качестве
    ...
    this.render = function (HTMLElementClass) {
        ...
        /*Находим HTML-элемент, в который вводятся URL изображений, и HTML-элемент,
        отображающий изображения.*/
        ...
        /*Востанавливаем из уровня BLL массив с URL изображений. Если восстановили такой массив,
        то на основе каждого URL в этом массив отрисовываем изображения на странице.*/
        ...
        /*Подписываем на событие отжатой клавиши "Enter" HTML-элемент, в который вводятся 
        URL изображений.*/
        this._photoURLInputElement.addEventListener('keyup', (event) => {
            if (event.code == 'Enter') {
                ...
                /*На основе полученного URL изображения, добавляем на страницу
                это изображений.*/
    ...
    /*Вспомогательный метод, который добавляет изображения на страницу. В
    качестве параметров получает URL изображения и HTML-элемент, в котором
    нужно отобразить это изображений.*/
