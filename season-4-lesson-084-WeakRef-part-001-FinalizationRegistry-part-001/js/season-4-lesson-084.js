...
"deref()" возвращает объект-референт, на который ссылается "WeakRef", в случае, если объект всё еще находится в памяти.
...
нет сильных ссылок. То есть наш объект становится своеобразным "котом Шрёдингера" - мы не можем знать точно, "жив" он
или "мертв".*/
