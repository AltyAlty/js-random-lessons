...
/*Метод "createConicGradient()" создает градиент вокруг точки с заданными координатами под углом, под которым начинается
градиент, в радианах. Этот угол начинается с линии, идущей горизонтально прямо из центра, и продолжается по часовой
стрелке. Этот метод возвращает конический объект типа "CanvasGradient". Чтобы применить градиент к фигуре, его
необходимо сначала присвоить свойствам "fillStyle" или "strokeStyle".*/
