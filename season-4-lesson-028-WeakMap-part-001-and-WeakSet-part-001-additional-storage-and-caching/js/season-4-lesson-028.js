...
сделать это частично. По этой причине методы для доступа ко всем сразу ключам/значениям недоступны.*/
...
let result03_02 = process(obj03); // Взяли резудьтат из кэша.
